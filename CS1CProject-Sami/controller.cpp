...
QVector<int> controller::readEllipse()
{
    QSqlQuery qry;
    int dimenOne;
    int dimenTwo;
    ...
    {
         qDebug() << "Error reading Ellipse dimensions" << endl;
    }
    qry.clear();
    QVector<int> ellipsePoints(4);
    ellipsePoints[0] = dimenOne;
    ellipsePoints[1]= dimenTwo;
    ellipsePoints[2]=dimenThree;
    ellipsePoints[3]=dimenFour;

    return ellipsePoints;
}

QVector<QString> controller::readEllipseEnums()
{
    QSqlQuery qry;
    ...
    {
         qDebug() << "Error reading Ellipse Enums" << endl;
    }

    qry.clear();

     QVector<QString> ellipseEnums(7);
     ellipseEnums[0] = color;
     ellipseEnums[1] = width;
     ellipseEnums[2] = style;
     ellipseEnums[3] = capStyle;
     ellipseEnums[4] = joinStyle;
     ellipseEnums[5] = brushColor;
     ellipseEnums[6] = brushStyle;

     return ellipseEnums;
}

QVector<int> controller::readCircle()
{
    QSqlQuery qry;
    int dimenOne;
    int dimenTwo;
    ...
    {
         qDebug() << "Error reading Circle dimensions" << endl;
    }
    qry.clear();
    QVector<int> circlePoints(4);
    circlePoints[0] = dimenOne;
    circlePoints[1]= dimenTwo;
    circlePoints[2]=dimenThree;

    return circlePoints;
}

QVector<QString> controller::readCircleEnums()
{
    QSqlQuery qry;
    ...
    {
         qDebug() << "Error reading Circle Enums" << endl;
    }
    ...
    qry.clear();
     ...
     circleEnums[1] = width;
     circleEnums[2] = style;
     circleEnums[3] = capStyle;
     circleEnums[4] = joinStyle;
     circleEnums[5] = brushColor;
